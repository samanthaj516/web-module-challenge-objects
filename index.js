...
*/
 ...
 export const burger = {
  ...
  console.log(this.percentage[key]);
  },
  percentage: {
    teacher: 13.5,
    student: 20,
...
reviews.push ({name: "Mary", rating: 0, feedback: "Absolutely hated everything about this place."});
console.log(reviews);
...
function getReviewByIndex(array, position) {
  let name = array[position].name;
  let rating = array[position].rating;
  let feedback = array[position].feedback;
...
function getLastReview(array) {
  console.log(getReviewByIndex(array, array.length - 1));
} 
